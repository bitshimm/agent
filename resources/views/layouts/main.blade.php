            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarTogglerDemo03">
                <ul class="navbar-nav  mb-2 mb-lg-0">
                    <li class="nav-item m-2">
                        <a href="#" role="button" class="nav-link border border-light" data-bs-toggle="modal" data-bs-target="#exampleModal1">Продукты и услуги</a>
                    </li>
                    <li class="nav-item m-2">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <div class="photo-slider px-4">
                        <a class="photo-item" data-fancybox="gallery" href="#">
                            <img src="https://volga-flot.ru/wp-content/uploads/2018/02/tseny-i-raspisanie-kruizov-po-volge-iz-samary-v-2018-godu.jpg)" alt="">
                        </a>
                        <a class="photo-item" data-fancybox="gallery" href="#">
                            <img src="https://volga-flot.ru/wp-content/uploads/2018/02/tseny-i-raspisanie-kruizov-po-volge-iz-samary-v-2018-godu.jpg)" alt="">
                        </a>
