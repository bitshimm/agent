        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm 12">
                ...
                <div class="mb-3">
                    ...
                    <div class="news-img-item" style="background: url('/storage/{{ $news->path_to_file }}');">

                    </div>
                </div>
                <div class="mb-3">
                    <label for="short_desc" class="form-label">Короткое описание</label>
                    <input type="tishort_descle" class="form-control" id="short_desc" name="short_desc" value="{{ $news->short_desc }}">
                </div>
                <div class="mb-3">
